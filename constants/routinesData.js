...
export const ROUTINES_DATA = {
  ...
  unknown: {
    name: 'Gentle Balanced',
    description: "Safe, balanced care while we discover your skin's needs",
    emoji: '🔍',
    basic: {
      title: 'Essential Care',
      description: 'Gentle fundamentals that work for all skin types',
      steps: {
        am: [
          'Gentle Cleanser',
          'Light Moisturizer',
      ...
      keyBenefits: ['Safe for all', 'Gentle formula', 'Daily protection']
    },
    moderate: {
      title: 'Balanced Protection',
      description: 'Complete care with gentle actives for common concerns',
      steps: {
        am: [
      ...
      keyBenefits: ['Balanced care', 'Antioxidant boost', 'Gentle actives']
    },
    comprehensive: {
      title: 'Complete Skin Discovery',
      description: 'Full routine with multiple benefits while learning your skin',
      steps: {
        am: [
        ...
        pm: [
          ...
          'Gentle Exfoliant (2×/week)',
          'Treatment Serum',
          'Eye Cream',
          'Rich Night Cream'
        ]
      },
      keyBenefits: ['Full coverage', 'Anti-aging prep', 'Multi-layer care', 'Gentle discovery']
    }
  }
};

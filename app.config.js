export default ({ config }) => {
  ...
  return {
    expo: {
      ...
      ios: {
        bundleIdentifier: "com.aleboshi.dracne",
        buildNumber: "3",
        usesAppleSignIn: true,
        supportsTablet: true,
        infoPlist: {
          NSCameraUsageDescription: "DrAcne uses the camera to take photos for AI acne analysis.",
          NSPhotoLibraryUsageDescription: "DrAcne accesses your photo library to select images for AI acne analysis.",
          NSUserTrackingUsageDescription: "This app uses data for personalized ads and analytics.",
          FacebookAppID: "4296363337358170",
          FacebookDisplayName: "Dr. Acne",
      ...
      extra: {
        ...
        router: {},
        eas: {
          projectId: "5a2844bb-64f1-48ab-ac84-13c7f3e4c665"
        }
      }
    }
  };

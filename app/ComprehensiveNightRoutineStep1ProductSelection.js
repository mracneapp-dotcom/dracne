...
const CLEANSER_PRODUCTS = {
  ...
  normal: [
    ...
    },
    {
      ...
      benefits: ['Low pH', 'Effective', 'Light'],
    },
  ],
  sensitive: [
    {
...
export default function ComprehensiveNightRoutineStep1ProductSelection({ 
  onNavigateHome,
  ...
  const handleContinue = async () => {
    if (selectedProducts.length > 0 && onContinue) {
      try {
        ...
        console.log('Saved cleansers to Comprehensive Night Routine:', selectedProducts);
      } catch (error) {

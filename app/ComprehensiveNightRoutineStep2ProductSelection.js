...
const MOISTURIZER_PRODUCTS = {
  ...
  combination: [
    {
      id: 'night_moist_combo_1',
      name: 'Beauty of Joseon Dynasty Cream',
      description: 'Balanced cream suitable for all zones',
      benefits: ['Balanced', 'Versatile', 'Night-friendly'],
    },
    {
      id: 'night_moist_combo_2',
      name: 'Isntree Aloe Soothing Gel',
      description: 'Light gel with aloe and centella',
      benefits: ['Soothing', 'Lightweight', 'Adaptable'],
    },
    {
      id: 'night_moist_combo_3',
      name: 'Clinique Moisture Surge',
      description: 'Auto-replenishing hydration',
      benefits: ['Oil-free', 'Hydrating', 'Balanced'],
    },
    {
      id: 'night_moist_combo_4',
      name: 'Neutrogena Hydro Boost',
      description: 'Gel-cream for combination skin',
      benefits: ['Versatile', 'Affordable', 'Night use'],
    },
    {
      id: 'night_moist_combo_5',
      name: 'COSRX Snail 92',
      description: 'Lightweight yet nourishing cream',
      benefits: ['Adaptable', 'Repairing', 'Zone-friendly'],
    },
  ],
  normal: [
    {
      id: 'night_moist_normal_1',
      name: 'COSRX Snail 92 All In One Cream',
      description: 'Perfect hydrating cream for balanced skin',
      benefits: ['Balanced', 'Repairing', 'Night recovery'],
    },
    {
      id: 'night_moist_normal_2',
      name: 'Beauty of Joseon Dynasty Cream',
      description: 'Classic K-beauty moisturizer',
      benefits: ['Elegant', 'Balanced', 'Overnight care'],
    },
    {
      id: 'night_moist_normal_3',
      name: 'Clinique Moisture Surge',
      description: 'Auto-replenishing hydration',
      benefits: ['Hydrating', 'Reliable', 'Oil-free'],
    },
    {
      id: 'night_moist_normal_4',
      name: 'Eucerin Lotion',
      description: 'Simple effective night moisturizer',
      benefits: ['Lightweight', 'Budget-friendly', 'Gentle'],
    },
    {
      id: 'night_moist_normal_5',
      name: 'Neutrogena Hydro Boost',
      description: 'Gel-cream with hyaluronic acid',
      benefits: ['Hydrating', 'Fresh', 'Night-appropriate'],
    },
  ],
  sensitive: [
    {
      id: 'night_moist_sens_1',
      name: 'Illiyoon Ceramide Ato',
      description: 'Gentle barrier repair cream',
      benefits: ['Minimal ingredients', 'Ceramides', 'Overnight repair'],
    },
    {
      id: 'night_moist_sens_2',
      name: 'La Roche-Posay Toleriane Dermallergo',
      description: 'Ultra-gentle moisturizer for reactive skin',
      benefits: ['Dermatologist-tested', 'Fragrance-free', 'Night recovery'],
    },
    {
      id: 'night_moist_sens_3',
      name: 'CeraVe Moisturizing Cream',
      description: 'Gentle ceramide cream',
      benefits: ['Affordable', 'Ceramides', 'Safe'],
    },
    {
      id: 'night_moist_sens_4',
      name: 'A-Derma Dermalibour',
      description: 'Repairing cream for sensitive skin',
      benefits: ['Soothing', 'Repairing', 'Night-time barrier'],
    },
    {
      id: 'night_moist_sens_5',
      name: 'First Aid Beauty Ultra Repair',
      description: 'Gentle intensive moisturizer',
      benefits: ['Colloidal oatmeal', 'Safe', 'Overnight care'],
    },
  ],
};

export default function ComprehensiveNightRoutineStep2ProductSelection({ 
  onNavigateHome,
  ...
  const handleContinue = async () => {
    if (selectedProducts.length > 0 && onContinue) {
      try {
        ...
        console.log('Saved moisturizers to Comprehensive Night Routine:', selectedProducts);
      } catch (error) {

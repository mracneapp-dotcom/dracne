// app/BasicRoutineStep1ProductSelection.js - FULLY TRANSLATED WITH PROPER BANNER
...
const CLEANSER_PRODUCTS = {
  oily: [
    ...
    },
    {
      ...
      benefitKeys: ['ph_balanced', 'refreshing', 'daily_use'],
    },
    {
      id: 'cleanser_oily_3',
  ...
  dry: [
    ...
    },
    {
      ...
      benefitKeys: ['ph_balanced', 'hypoallergenic', 'moisturizing'],
    },
    {
      id: 'cleanser_dry_3',
  ...
  sensitive: [
    ...
    },
    {
      ...
      benefitKeys: ['ph_balanced', 'tested', 'soft'],
    },
    {
      id: 'cleanser_sens_3',
      name: 'Vanicream Gentle Cleanser',
...
export default function BasicRoutineStep1ProductSelection({ 
  onNavigateHome,
        ...
        <View style={styles.content}>
          ...
          <View style={styles.explanationBox}>
            <Text style={styles.explanationText}>
              {t('basicRoutine.explanation_cleanser_selection')}
            </Text>
          </View>
          ...
          <View style={styles.citationContainer}>
            <Text style={styles.citationText}>
              {t('basicRoutine.citation_cleanser_products_intro')}{' '}
              <Text 
                style={styles.citationLink}
                onPress={() => Linking.openURL('https://www.cir-safety.org/ingredients')}
              >
                {t('basicRoutine.citation_cleanser_products_link1')}
              </Text>
              , {t('basicRoutine.citation_cleanser_products_research')}{' '}
              <Text 
                style={styles.citationLink}
                onPress={() => Linking.openURL('https://onlinelibrary.wiley.com/journal/14682494')}
              >
                {t('basicRoutine.citation_cleanser_products_link2')}
              </Text>
              , {t('basicRoutine.citation_cleanser_products_studies')}{' '}
              <Text 
                style={styles.citationLink}
                onPress={() => Linking.openURL('https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5849435/')}
              >
                {t('basicRoutine.citation_cleanser_products_link3')}
              </Text>
